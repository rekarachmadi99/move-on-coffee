...
<body id="page-top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pemasukan Dan Pengeluaran
                                        {{ date('Y') }}</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Grafik Pendapatan Bersih</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-area">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Reka Rachmadi A</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script>
        const laporanKeuangan = document.getElementById('grafikLaporanKeuangan');

        new Chart(laporanKeuangan, {
            type: 'bar',
            data: {
                labels: ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September',
                    'Oktober', 'November', 'Desember'
